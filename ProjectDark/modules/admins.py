...
async def member_ban(client: Client, message: Message):
    ...
    if not bot.can_restrict_members:
        return await Dark.edit("I don't have enough permissions")
    if not user_id:
        return await Dark.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Dark.edit("I can't ban myself.")
    if user_id in DEVS:
        return await Dark.edit("I can't ban my developer!")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Dark.edit("I can't ban an admin, You know the rules, so do i.")
    try:
...
async def member_unban(client: Client, message: Message):
    ...
    if reply and reply.sender_chat and reply.sender_chat != message.chat.id:
        return await Dark.edit("You cannot unban a channel")
...
async def mute(client: Client, message: Message):
    ...
    if not user_id:
        return await Dark.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Dark.edit("I can't mute myself.")
    if user_id in DEVS:
        return await Dark.edit("I can't mute my developer!")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Dark.edit("I can't mute an admin, You know the rules, so do i.")
    mention = (await client.get_users(user_id)).mention
    msg = (
...
async def kick_user(client: Client, message: Message):
    ...
    if not user_id:
        return await Dark.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Dark.edit("I can't kick myself.")
    if user_id == DEVS:
        return await Dark.edit("I can't kick my developer.")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Dark.edit("I can't kick an admin, You know the rules, so do i.")
    mention = (await client.get_users(user_id)).mention
    msg = f"""
**Kicked User:** {mention}
**Kicked By:** {message.from_user.mention if message.from_user else 'Anon'}"""
    ...
    try:
        ...
        return await Dark.edit("**Maaf Anda Bukan admin**")
...
async def promotte(client: Client, message: Message):
    ...
    if message.command[0][0] == "f":
        ...
        return await Dark.edit(f"Fully Promoted! {umention}")
...
async def demote(client: Client, message: Message):
    ...
    if not user_id:
        return await Dark.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Dark.edit("I can't demote myself.")
    await message.chat.promote_member(
        user_id,
        privileges=ChatPrivileges(
