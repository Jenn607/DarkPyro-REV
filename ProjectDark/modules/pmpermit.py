...
DEF_UNAPPROVED_MSG = (
"```This message is sent automatically by the session to prevent unknown users from spamming. Your message will be replied to immediately if the account owner is online and as long as it don't spam```"
)
